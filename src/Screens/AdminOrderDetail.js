            ...
            >
              ...
              {adminOrderDetail.orderType === 'CARD_Init' && <Box component="form" sx={{ '& .MuiTextField-root': { m: 1, width: '25ch' } }}
                ...
                {adminOrderDetail.cardType === 'IntCredits' ? <>
                  <TextField id="standard-read-only-input" label="Loại thẻ"
                    defaultValue={'Thẻ tín dụng'} InputProps={{ readOnly: true }} variant="standard" />

                  <TextField id="standard-read-only-input" label="Tên thẻ"
                    defaultValue={adminOrderDetail.cardTypeId.cardName} InputProps={{ readOnly: true }} variant="standard" />

                  <TextField id="standard-read-only-input" label="Nhà phát hành"
                    defaultValue={adminOrderDetail.cardTypeId.publisher} InputProps={{ readOnly: true }} variant="standard" />

                  <TextField id="standard-read-only-input" label="Hạng thẻ"
                    defaultValue={adminOrderDetail.cardTypeId.cardRank} InputProps={{ readOnly: true }} variant="standard" />

                  <TextField id="standard-read-only-input" label="Hạng mức tín dụng"
                    defaultValue={adminOrderDetail.cardTypeId.creditLine} InputProps={{ readOnly: true }} variant="standard" />

                  <TextField id="standard-read-only-input" label="Điều kiện mở thẻ"
                  ...
                  <TextField id="standard-read-only-input" label="Loại thẻ"
                    defaultValue={'Thẻ ghi nợ quốc tế'} InputProps={{ readOnly: true }} variant="standard" />
                  ...
                  <TextField id="standard-read-only-input" label="Mức sử dụng tối đa trong ngày"
                  ...
                  <TextField id="standard-read-only-input" label="Loại thẻ"
                    defaultValue={'Thẻ ghi nợ nội địa'} InputProps={{ readOnly: true }} variant="standard" />
              ...
              {adminOrderDetail.orderType === 'CARD_Cancel' && <Box component="form" sx={{ '& .MuiTextField-root': { m: 1, width: '25ch' } }}
                ...
                {adminOrderDetail.cardId.cardType === 'IntCredits' ? <>
                  ...
                  <TextField id="standard-read-only-input" label="Số thẻ"
                  ...
                  <TextField id="standard-read-only-input" label="Trạng thái thẻ"
                    defaultValue={adminOrderDetail.cardId.isActive ? 'Được kích hoạt' : 'Chưa kích hoạt'} InputProps={{ readOnly: true }} variant="standard" />

                  <TextField id="standard-read-only-input" label="Mức tín dụng đã dùng"
                    defaultValue={adminOrderDetail.cardId.currentUsed} InputProps={{ readOnly: true }} variant="standard" />

                  <TextField id="standard-read-only-input" label="Mức nợ của thẻ"
                    defaultValue={adminOrderDetail.cardId.debt} InputProps={{ readOnly: true }} variant="standard" />

                  <TextField id="standard-read-only-input" label="Ngày phát hành" defaultValue={localTime(adminOrderDetail.cardId.validDate)}
                    InputProps={{ readOnly: true }} style={{ width: "265px" }} fullWidth="true" variant="standard" />

                  <TextField id="standard-read-only-input" label="Ngày hết hạn" defaultValue={localTime(adminOrderDetail.cardId.expiredDate)}
                    InputProps={{ readOnly: true }} style={{ width: "265px" }} fullWidth="true" variant="standard" />
                  ...
                  <TextField id="standard-read-only-input" label="Mức tiền đã dùng trong ngày"
                    defaultValue={adminOrderDetail.cardId.currentUsed} InputProps={{ readOnly: true }} variant="standard" />
              ...
              {adminOrderDetail.orderType === 'PaymentGate_Init' && <Box component="form" sx={{ '& .MuiTextField-root': { m: 1, width: '25ch' } }}
                style={{ border: '1px solid grey', padding: "20px 0 20px 20px" }} noValidate autoComplete="off">
                <TextField id="standard-read-only-input" label="Loại cổng"
                  defaultValue={adminOrderDetail.isGlobal ? 'Cổng Quốc Tế' : 'Cổng Nội Địa'} InputProps={{ readOnly: true }} variant="standard" />
              </Box>}

              {adminOrderDetail.orderType === 'PaymentGate_Cancel' && <Box component="form" sx={{ '& .MuiTextField-root': { m: 1, width: '25ch' } }}
                style={{ border: '1px solid grey', padding: "20px 0 20px 20px" }} noValidate autoComplete="off">
                <TextField id="standard-read-only-input" label="Loại cổng"
                  defaultValue={adminOrderDetail.gateId.isGlobal ? 'Cổng Quốc Tế' : 'Cổng Nội Địa'} InputProps={{ readOnly: true }} variant="standard" />

                <TextField id="standard-read-only-input" label="Mã API Cổng"
                  defaultValue={adminOrderDetail.gateId.apiKey} InputProps={{ readOnly: true }} variant="standard" />

                <TextField id="standard-read-only-input" label="Trạng thái cổng"
                  defaultValue={adminOrderDetail.gateId.isActive ? 'Được kích hoạt' : 'Chưa kích hoạt'} InputProps={{ readOnly: true }} variant="standard" />
              </Box>}
